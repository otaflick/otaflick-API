...
router.get('/addAnimeRoute', isAdminAuthenticated, (req, res) => {
  res.render('addAnimeList.hbs');
});

router.get('/updateAnimeRoute', isAdminAuthenticated, (req, res) => {
  res.redirect('/edit-anime-list');
});

router.get('/deleteAnimeRoute', isAdminAuthenticated, (req, res) => {
  res.redirect('/delete-anime');
});

router.get('/online', isAdminAuthenticated, (req, res) => {
  res.redirect('/online-user');
});
